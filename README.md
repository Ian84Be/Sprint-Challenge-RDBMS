...
RDBMS is a software solution for managing a relational database. SQL is the language used to communicate with the database.

1. Why do tables need a `primary key`?

The primary key is used as an identifier for the resource within the table, it can also be used as a foreign key to join data to other tables.
